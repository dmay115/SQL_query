...
SELECT app_name, reviews, COUNT(*) FROM analytics GROUP BY app_name, reviews ORDER BY reviews DESC LIMIT 5;
--5. Find the app that has the most reviews with a rating greater than equal to 4.8.
SELECT app_name, reviews FROM analytics  WHERE rating >= 4.8 GROUP BY app_name, reviews ORDER BY reviews DESC LIMIT 1;
...
SELECT app_name, reviews, min_installs, min_installs/reviews AS ratio FROM analytics WHERE min_installs >= 100000 ORDER BY min_installs/reviews DESC LIMIT 1;